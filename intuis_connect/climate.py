...
from .const import PRESET_HG, PRESET_AWAY, PRESET_BOOST, PRESET_SCHEDULE, API_MODE_OFF, API_MODE_AUTO, API_MODE_HG, API_MODE_MANUAL, \
    API_MODE_AWAY, API_MODE_BOOST, API_MODE_HOME, DEFAULT_AWAY_TEMP, DEFAULT_AWAY_DURATION, DEFAULT_BOOST_TEMP, DEFAULT_HG_TEMP,\
...
class IntuisConnectClimate(
    ...
    _attr_hvac_modes = [HVACMode.AUTO, HVACMode.HEAT, HVACMode.OFF, HVACMode.FAN_ONLY]
    _attr_preset_modes = [PRESET_AWAY, PRESET_BOOST, PRESET_SCHEDULE, PRESET_HG]
    ...
    def hvac_mode(self) -> HVACMode | None:
        ...
        if mode in (API_MODE_MANUAL, API_MODE_AWAY, API_MODE_BOOST, API_MODE_HG):
    ...
    async def async_set_hvac_mode(self, hvac_mode: HVACMode) -> None:
        ...
        if hvac_mode == HVACMode.OFF:
            ...
            await self._api.async_set_room_state(self._get_room().id, API_MODE_HG)
